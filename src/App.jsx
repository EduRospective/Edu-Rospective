...
const initialAnunturi = [{ id: 1, titlu: "Ședință CP", text: "Miercuri 16:00", data: new Date().toISOString() }];
...
function TemplatesManager() {
  const templates = [
    { id: "pdi", titlu: "Model PDI", text: `Titlu PDI\nObiective...\nIndicatori...\nActivități...` },
    { id: "poa", titlu: "Model POA", text: `Titlu POA\nActivități anuale...\nResponsabili...` },
  ];
